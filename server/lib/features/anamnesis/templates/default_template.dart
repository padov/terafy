/// Template padrão de anamnese do sistema
/// Baseado nas boas práticas clínicas e na documentação de negócio
class DefaultAnamnesisTemplate {
  static Map<String, dynamic> getStructure() {
    return {
      'version': '1.0',
      'metadata': {
