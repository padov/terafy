...
- **Templates Personalizáveis**
  - Use o template padrão do sistema ou crie seus próprios
  - Templates podem ser reutilizados para diferentes pacientes
...
- **Cadastro de Terapeuta**
  - Cadastre-se facilmente no aplicativo
  - Complete seu perfil profissional com informações como CRP, CRM, etc.
...
- **Dashboard do Paciente**
  - Visualize todas as informações do paciente em um só lugar
  - Acompanhe o status do paciente (ativo, inativo, avaliado, em alta, alta concluída)
...
- **Detalhes do Agendamento**
  - Veja todas as informações do agendamento
  - Edite agendamentos facilmente
...
- **Relatórios Financeiros**
  - Visualize relatórios financeiros básicos
...
- **✨ Novidades**: Funcionalidades completamente novas adicionadas ao aplicativo
- **🔧 Melhorias**: Melhorias em funcionalidades existentes
- **🐛 Correções**: Correções de bugs e problemas
- **📝 Documentação**: Atualizações na documentação ou ajuda
