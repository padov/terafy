...
void main() {
  group('TodayAppointment', () {
    testWidgets('exibe estado vazio quando não há compromissos', (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(body: TodayAppointment(appointments: const [])),
        ),
      );
    ...
    testWidgets('renderiza lista de compromissos', (tester) async {
      ...
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(body: TodayAppointment(appointments: appointments)),
        ),
      );
      await tester.pumpAndSettle();
