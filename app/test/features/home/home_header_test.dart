  ...
  group('HomeHeader', () {
    testWidgets('renderiza avatar com iniciais quando não há foto', (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: HomeHeader(userName: 'João Silva', userRole: 'Terapeuta'),
          ),
        ),
      );
    ...
    testWidgets('renderiza iniciais com nome único', (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: HomeHeader(userName: 'Maria', userRole: 'Terapeuta'),
          ),
        ),
      );
    ...
    testWidgets('renderiza nome e role do usuário', (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: HomeHeader(userName: 'Dr. João Silva', userRole: 'Terapeuta'),
          ),
        ),
      );
        ...
        MaterialApp(
          home: Scaffold(
            body: HomeHeader(
              userName: 'João Silva',
              userRole: 'Terapeuta',
              plan: const TherapistPlan(id: 0, name: 'Free', price: 0.0, patientLimit: 5),
            ),
          ),
        ),
      );
        ...
        MaterialApp(
          home: Scaffold(
            body: HomeHeader(
              userName: 'João Silva',
              userRole: 'Terapeuta',
              plan: const TherapistPlan(id: 1, name: 'Premium', price: 99.0, patientLimit: 50),
            ),
          ),
        ),
      );
    ...
    testWidgets('exibe contador de notificações quando maior que zero', (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: HomeHeader(userName: 'João Silva', userRole: 'Terapeuta', notificationCount: 5),
          ),
        ),
      );
    ...
    testWidgets('exibe 9+ quando notificações são maiores que 9', (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: HomeHeader(userName: 'João Silva', userRole: 'Terapeuta', notificationCount: 15),
          ),
        ),
      );
    ...
    testWidgets('não exibe contador quando notificações são zero', (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: HomeHeader(userName: 'João Silva', userRole: 'Terapeuta', notificationCount: 0),
          ),
        ),
      );
